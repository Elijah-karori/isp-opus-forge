          ...
          <div className="space-y-6">
            ...
            <div className="text-center">
              <Button
                ...
                disabled={isSendingMagicLink}
              >
                {isSendingMagicLink ? 'Sending...' : 'Resend Code'}
              </Button>
            </div>
          </div>
        </div>
  ...
  if (view === 'forgot-password') {
    return (
      <div className="min-h-screen flex flex-col bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900 px-6">
        ...
        <div className="flex-1 flex flex-col justify-center pb-20">
          <div className="w-16 h-16 bg-gradient-to-br from-orange-500 to-orange-600 rounded-2xl flex items-center justify-center mb-8 shadow-lg shadow-orange-500/30">
            <KeyRound className="h-8 w-8 text-white" />
          </div>

          <h2 className="text-3xl font-bold text-white mb-2">Forgot Password?</h2>
          <p className="text-blue-200 mb-8">No worries, we'll send you reset instructions</p>
          ...
          <div className="space-y-4">
            ...
            <Button
              ...
              className="w-full h-14 bg-orange-500 hover:bg-orange-600 text-white font-semibold text-lg shadow-lg shadow-orange-500/30"
              disabled={isLoading}
            >
              {isLoading ? (
                <>
    ...
    return (
      <div className="min-h-screen flex flex-col bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900 px-6">
        ...
        <div className="flex-1 flex flex-col justify-center pb-20">
          ...
          <div className="space-y-4">
            <div className="space-y-2">
              <Label className="text-blue-100">Reset Code</Label>
              <div className="flex justify-center">
                <InputOTP
                  maxLength={6}
                  value={resetToken}
            ...
            <div className="space-y-2">
              <Label className="text-blue-100">New Password</Label>
              <div className="relative">
                <Lock className="absolute left-4 top-1/2 transform -translate-y-1/2 text-blue-300 h-5 w-5" />
                <Input
                  type="password"
            ...
            <Button
              ...
              className="w-full h-14 bg-green-500 hover:bg-green-600 text-white font-semibold text-lg shadow-lg shadow-green-500/30"
              disabled={isLoading}
            >
              {isLoading ? (
                <>

...
export const COMPLETE_MENU: MenuItem[] = [
    ...
    },
    {
        ...
        path: '/workflows',
        icon: 'GitBranch',
        // More permissive - show to anyone who can read tasks, projects, or workflows
        anyPermissions: ['workflow:read:all', 'workflow:approve:all', 'workflow:approve:department', 'task:read:all', 'project:read:all'],
        children: [
            {
                key: 'workflows-dashboard',
                label: 'Dashboard',
                path: '/workflow-dashboard',
                anyPermissions: ['workflow:read:all', 'workflow:approve:all', 'workflow:approve:department', 'task:read:all'],
            },
            {
                key: 'workflows-list',
                label: 'All Workflows',
                path: '/workflows',
                anyPermissions: ['workflow:read:all', 'task:read:all'],
            },
            {
